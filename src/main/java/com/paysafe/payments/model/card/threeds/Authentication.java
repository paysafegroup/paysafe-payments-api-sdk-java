...
public class Authentication {
  ...
  public Authentication eci(Long eci) {
    this.eci = eci;
    return this;
  }
   ...
   * cardholder was successfully authenticated. Note that in some cases the eci value includes a leading zero, e.g., 01 or 02. <br.
   * <p>
   * Visa: <br />
   * • 5 - Identifies a successfully authenticated transaction. <br />
   * • 6 - Identifies an attempts authenticated transaction. <br />
   * • 7 - Identifies a non-authenticated transaction.  <br />
   * <br />
   * Mastercard: <br />
   * • 2 - Identifies a successfully authenticated transaction. <br />
   * • 1 - Identifies an attempts authenticated transaction. <br />
   * • 0 - Identifies a non-authenticated transaction. <br />
   *
   * @return eci
   */
  public Long getEci() {
  ...
  /**
   * This is the status of the Enrollment Lookup request. Possible values are:  <br />
   ...
   * • U – Cardholder authentication unavailable <br />
   * <p>
   *
  ...
  /**
   * This is the 3D Secure signature verification result value. <br />
   * • Y – All transaction and signature checks satisfied.  <br />
   * • N – At least one transaction or signature check failed. <br />
   *
