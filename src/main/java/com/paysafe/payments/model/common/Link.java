...
public class Link {
   ...
   * - redirect_registration - Merchant needs to redirect consumer to this url to complete registration. <br />
   * - redirect_payment - Merchant needs to redirect consumer to this url to complete authentication. <br />
   * - on_completed - Paysafe will return to this merchant url post successful payment. <br />
   * - on_failed - Paysafe will return to this merchant url post if payment is failed. <br />
   * - on_cancelled - Paysafe will return to this merchant url post if payment is cancelled. <br />
