...
public class StoredCredential {
   ...
   * <p>
   * This id should be stored from the auth response of the transaction indicated as initial with the following: <br />
   * - type=RECURRING/TOPUP, occurrence=INITIAL. <br />
   * <p>
   * This reference should be provided when: <br />
   * - type = RECURRING and occurrence = SUBSEQUENT  <br />
   * - type = TOPUP and occurrence = SUBSEQUENT <br />
   *
   ...
   * This reference should be provided only when: <br />
   * - type=RECURRING and occurrence=SUBSEQUENT <br />
   * - type=TOPUP and occurrence=SUBSEQUENT <br />
   *
