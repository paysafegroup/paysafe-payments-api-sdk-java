...
/**
 * This specifies whether this stored credential request is initial or recurring. Possible values are: <br />
 * - INITIAL – Used when this is the first time the consumer uses this credit card. <br />
 * - SUBSEQUENT – Used when the consumer uses this credit card for subsquent requests.  <br />
 *
