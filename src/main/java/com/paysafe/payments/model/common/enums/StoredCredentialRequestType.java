 ...
 * • ADHOC – Ad hoc consumer-initiated request <br />
 * • TOPUP – Unscheduled merchant-iniitated request when a consumer balance is below a set limit. <br />
 * • RECURRING – Scheduled, merchant-initiated recurring request. <br />
 * 
