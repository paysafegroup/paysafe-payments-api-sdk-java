...
public class CustomerPaymentHandle {
  ...
  /**
   * This specifies how the Payment Handle will be used for Payments.  <br />
   * • SINGLE_USE - The Payment Handle can be used only for one time. <br />
  ...
  public CustomerPaymentHandle amount(Long amount) {
    this.amount = amount;
    return this;
  }
