...
public class PaymentRequest {
   ...
   * - The BIN of the credit card used for the transaction must be eligible – typically,these are government-issued credit cards. <br />
   *
   ...
   *
   * <b>Notes: </b><br />
   * • If you use a paymentToken in the authorization request but do not include the storedCredential object, Paysafe will provide
   * default information taken from Customer Vault data. <br />
   * • You cannot include both the storedCredential object and the recurring parameter in the same authorization request.Paysafe recommends
   * using the storedCredential object.  <br />
   * • The cvv parameter of the [card object] is required when the occurrence parameteris set to INITIAL. However, cvv is not required
