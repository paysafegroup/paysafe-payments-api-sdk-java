...
public class StandaloneCredit {
  ...
  public StandaloneCredit amount(Long amount) {
    this.amount = amount;
    return this;
  }
  ...
  /**
   * This field contains the information representing the payment transaction funding source. Possible values: <br />
   * • Credit <br />
   * • Debit <br />
   * • Prepaid <br />
   * • Cash <br />
  ...
  public StandaloneCredit status(CreditRequestStatus status) {
    this.status = status;
    return this;
  }
