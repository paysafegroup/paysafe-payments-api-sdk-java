...
import static com.paysafe.ph.sdk.java.e2e.util.TestHttpClientProvider.createTestSslContext;
...
public class BasePaysafeClientTest {
  ...
  static void init() throws NoSuchAlgorithmException, KeyManagementException, IllegalArgumentException {
    ...
    System.out.println("Files root uri: " + wireMockServer.getOptions().filesRoot().getUri());
    for (TextFile textFile : wireMockServer.getOptions().filesRoot().listFilesRecursively()) {
